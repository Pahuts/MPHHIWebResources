...
$("fieldset[aria-label='Attach the Files you want to share with the Pharmacy Store'] .section-title").append("<br><p class='attach-files-subgrid'>The file you want to attach should not exceed 2 mb. Only .docx, .xlsx, .pdf, .jpg, and .png file types are allowed. <br> Please attach if you have any Discount IDs and a copy of your Prescription.</p>");
