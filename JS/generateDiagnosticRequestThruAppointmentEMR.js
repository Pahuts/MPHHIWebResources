function generateDiagnosticPrescriptionThruAppointmentEMR(formContext) {
    formContext.ui.setFormNotification("Documents are being uploaded to sharepoint. Files with the same file names will be overwritten.",  "INFO", "1");
    ...
    parameters.AptTemplateId = "6a58ddb0-54bf-eb11-8236-000d3a1b6443"; 
