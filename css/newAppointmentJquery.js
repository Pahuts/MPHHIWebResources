...
$("fieldset[aria-label='Attach the Files you want to share with your Doctor'] .section-title").append("<br><p class='attach-files-subgrid'>The file you want to attach should not exceed 5 mb. Only .docx, .xlsx, .pdf, .jpg, and .png file types are allowed.</p>");
