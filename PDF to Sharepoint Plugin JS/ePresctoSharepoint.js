function callGeneratePDFAction(formContext) {
  formContext.ui.setFormNotification("Documents are being uploaded to sharepoint. Please refresh the form in a while.", "INFO", "1");
    ...
    Xrm.WebApi.online.retrieveMultipleRecords("mphhi_eprescription", "?$select=_mphhi_appointment_value,_mphhi_doctor_value,mphhi_eprescriptioncode,_mphhi_patient_value&$filter=_mphhi_appointment_value eq "+aptID+"&$top=5").then(
      function success(results) {
          ...
          for (var i = 0; i < results.entities.length; i++) {
              ...
              customAction(primaryControl, aptID, fileName, noteSubject, mphhi_eprescriptionid);
          }
      },
      function(error) {
...
function customAction(primaryControl, aptID, fileName, noteSubject, mphhi_eprescriptionid) {
  ...
  parameters.OtherTemplateId = "a092c1c8-ee95-eb11-b1ac-0022481e8ade"; // old template guid c1fb558f-378d-eb11-a812-000d3a4e8e86
