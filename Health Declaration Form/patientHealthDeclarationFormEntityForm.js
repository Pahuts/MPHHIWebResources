...
// Enable/disable Submit button based on whether agreement has been accepted and 1 symptom is checked
  ...
  // Append Span
  $("fieldset[aria-label='covidchecklist']").append("<br> <span class='symptoms-header'> Symptoms Checklist </span>");
  // adjust terms and conditions
  $(".symptoms-checklist").append("<br><br><br>");
  // add class to terms and conditions section
  $("fieldset[aria-label='terms and conditions").css("margin-left", "20px");
